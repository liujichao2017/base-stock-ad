...
public class SysUser extends BaseEntity {
    ...
    public String getFundService() {
        return fundService;
    }

    public void setFundService(String fundService) {
    ...
    private Boolean excludeAdmin = false;

    public Boolean getExcludeAdmin() {
        return excludeAdmin;
    }

    public void setExcludeAdmin(Boolean excludeAdmin) {
