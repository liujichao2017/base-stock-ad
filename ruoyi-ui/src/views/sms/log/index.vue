<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="logList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="短信内容" align="center" prop="context"/>
      <el-table-column label="接口响应" align="center" prop="resBody"/>
      <el-table-column label="发送状态" align="center" prop="status">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sms_send_status" :value="scope.row.status"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="接口响应" prop="resBody">
...
<script>
import {addLog, delLog, getLog, listLog, updateLog} from "@/api/sms/log";

export default {
  name: "Log",
  dicts: ['sms_send_status'],
  data() {
    return {
      // 遮罩层
      loading: true,
