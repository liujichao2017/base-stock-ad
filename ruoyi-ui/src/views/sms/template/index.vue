...
<!--      </el-col>-->
    ...
    <el-table v-loading="loading" :data="templateList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="模板类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.sms_temple_type" :value="scope.row.type"/>
        </template>
      </el-table-column>
      <el-table-column label="短信内容模板" align="center" prop="context"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="短信内容模板" prop="context">
          <el-row>
...
<script>
import {addTemplate, delTemplate, getTemplate, listTemplate, updateTemplate} from "@/api/sms/template";

export default {
  name: "Template",
  dicts: ['sms_temple_type'],
  data() {
    return {
      // 遮罩层
      loading: true,
      ...
      rules: {
        ...
        context: [
          {required: true, message: "短信内容模板不能为空", trigger: "blur"}
        ],
      }
    };
  },
