    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['funds:recharge:edit']"
        >修改
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['funds:recharge:remove']"
        >删除
        </el-button>
      </el-col>
<!--      <el-col :span="1.5">-->
...
<!--          size="mini"-->
<!--          @click="handleExport"-->
<!--          v-hasPermi="['funds:recharge:export']"-->
<!--        >导出-->
<!--        </el-button>-->
<!--      </el-col>-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="会员Id" prop="memberId">
          <el-input :disabled="update" v-model="form.memberId" placeholder="请输入会员Id"/>
        </el-form-item>
        <el-form-item label="市场ID" prop="marketId">
          <MarketSelect ref="marketSelect" :disabled="update" :marketId="form.marketId"
                        @input="(val)=>{form.marketId = val}"/>
        </el-form-item>
        <el-form-item label="金额" prop="amt">
          <el-input :disabled="update" v-model="form.amt" placeholder="请输入金额"/>
        </el-form-item>
        <el-form-item label="状态" prop="status">
...
<script>
import {addRecharge, delRecharge, getRecharge, listRecharge, updateRecharge} from "@/api/funds/recharge";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除客户充值编号为"' + ids + '"的数据项？').then(function () {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('funds/recharge/export', {
        ...this.queryParams
